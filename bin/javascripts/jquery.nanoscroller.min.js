(function(){var c,e,d=function(a,b){return function(){return a.apply(b,arguments)}};c=this.jQuery;e=function(){function a(){this.el=target;this.generate();this.createEvents();this.addEvents();this.reset()}a.prototype.createEvents=function(){return this.events={down:d(function(b){this.isDrag=!0;this.offsetY=b.clientY-this.slider.offset().top;this.pane.addClass("active");c(document).bind("mousemove",this.events.drag);c(document).bind("mouseup",this.events.up);return!1},this),drag:d(function(b){this.sliderY=
