...
c.clientWidth;j.body.removeChild(c);return a};m=function(){function c(a,b){this.options=b;g||(g=o());this.el=e(a);this.doc=e(j);this.win=e(i);this.generate();this.createEvents();this.addEvents();this.reset()}c.prototype.preventScrolling=function(a,b){switch(a.type){case "DOMMouseScroll":("down"===b&&0<a.originalEvent.detail||"up"===b&&0>a.originalEvent.detail)&&a.preventDefault();break;case "mousewheel":if(!a.originalEvent||!a.originalEvent.wheelDelta)break;("down"===b&&0>a.originalEvent.wheelDelta||
...
this.sliderY=38===a||33===a?this.sliderY-b:this.sliderY+b,this.scroll();else if(36===a||35===a)this.sliderY=36===a?0:this.maxSliderTop,this.scroll()};c.prototype.createEvents=function(){var a=this;this.events={down:function(b){a.isBeingDragged=!0;a.offsetY=b.pageY-a.slider.offset().top;a.pane.addClass("active");a.doc.bind("mousemove",a.events.drag).bind("mouseup",a.events.up);return!1},drag:function(b){a.sliderY=b.pageY-a.el.offset().top-a.offsetY;a.scroll();a.updateScrollValues();a.scrollTop>=a.maxScrollTop?
a.el.trigger("scrollend"):0===a.scrollTop&&a.el.trigger("scrolltop");return!1},up:function(){a.isBeingDragged=!1;a.pane.removeClass("active");a.doc.unbind("mousemove",a.events.drag).unbind("mouseup",a.events.up);return!1},resize:function(){a.reset()},panedown:function(b){a.sliderY=b.offsetY-0.5*a.sliderHeight;a.scroll();a.events.down(b);return!1},scroll:function(b){a.isBeingDragged||(a.updateScrollValues(),a.sliderY=a.sliderTop,a.slider.css({top:a.sliderTop}),null!=b&&(a.scrollTop>=a.maxScrollTop?
(a.options.preventPageScrolling&&a.preventScrolling(b,"down"),a.el.trigger("scrollend")):0===a.scrollTop&&(a.options.preventPageScrolling&&a.preventScrolling(b,"up"),a.el.trigger("scrolltop"))))},wheel:function(b){if(null!=b)return a.sliderY+=-b.wheelDeltaY||-b.delta,a.scroll(),!1},keydown:function(b){var c;if(null!=b&&(c=b.which,38===c||33===c||40===c||34===c||36===c||35===c))a.sliderY=isNaN(a.sliderY)?0:a.sliderY,k[c]=setTimeout(function(){a.handleKeyPress(c)},100),b.preventDefault()},keyup:function(b){null!=
b&&(b=b.which,a.handleKeyPress(b),null!=k[b]&&clearTimeout(k[b]))}}};c.prototype.addEvents=function(){var a;a=this.events;this.options.disableResize||this.win.bind("resize",a.resize);this.slider.bind("mousedown",a.down);this.pane.bind("mousedown",a.panedown).bind("mousewheel",a.wheel).bind("DOMMouseScroll",a.wheel);this.content.bind("mousewheel",a.scroll).bind("DOMMouseScroll",a.scroll).bind("touchmove",a.scroll).bind("keydown",a.keydown).bind("keyup",a.keyup)};c.prototype.removeEvents=function(){var a;
