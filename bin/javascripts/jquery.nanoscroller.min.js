...
this.scrollW=h();if(0===this.scrollbarWidth)this.scrollW=0;this.content.css({right:-this.scrollW+"px"})};c.prototype.reset=function(){var a;if(!0===this.isDead)this.isDead=!1,this.pane.show(),this.addEvents();a=this.content[0];this.contentH=a.scrollHeight+this.scrollW;this.paneH=this.pane.outerHeight();this.sliderH=this.paneH/this.contentH*this.paneH;this.sliderH=Math.round(this.sliderH);this.scrollH=this.paneH-this.sliderH;this.slider.height(this.sliderH);this.diffH=a.scrollHeight-a.clientHeight;
this.pane.show();this.paneH>=this.content[0].scrollHeight&&this.pane.hide()};c.prototype.scroll=function(){var a;this.sliderY=Math.max(0,this.sliderY);this.sliderY=Math.min(this.scrollH,this.sliderY);a=this.paneH-this.contentH+this.scrollW;a=a*this.sliderY/this.scrollH;this.content.scrollTop(-a);return this.slider.css({top:this.sliderY})};c.prototype.scrollBottom=function(a){var b,c;b=this.diffH;c=this.content[0].scrollTop;this.reset();c<b&&0!==c||this.content.scrollTop(this.contentH-this.content.height()-
a)};c.prototype.scrollTop=function(a){this.reset();this.content.scrollTop(a+0)};c.prototype.stop=function(){this.isDead=!0;this.removeEvents();this.pane.hide()};return c}();d.fn.nanoScroller=function(c){var a;c||(c={});if(!(d.browser.msie&&8>parseInt(d.browser.version,10))){a=this.data("scrollbar");void 0===a&&(a=new g(this),this.data("scrollbar",a));if(c.scrollBottom)return a.scrollBottom(c.scrollBottom);if(c.scrollTop)return a.scrollTop(c.scrollTop);if("bottom"===c.scroll)return a.scrollBottom(0);
if("top"===c.scroll)return a.scrollTop(0);if(c.stop)return a.stop();a.reset()}}})(jQuery,window,document);