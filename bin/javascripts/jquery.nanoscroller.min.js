...
function(){c(window).unbind("resize",this.handler.onResize);this.slider.unbind("mousedown",this.handler.onDown);this.pane.unbind("mousedown",this.handler.onDownPane);return this.content.unbind("scroll",this.handler.onScroll)};b.prototype.getScrollbarWidth=function(){var a,b,c;c=document.createElement("div");a=document.createElement("div");c.style.position="absolute";c.style.width="100px";c.style.height="10px";c.style.overflow="hidden";a.style.width="100%";a.style.height="20px";c.appendChild(a);document.body.appendChild(c);
b=a.offsetWidth+0;c.style.overflow="auto";a=a.offsetWidth+0;document.body.removeChild(c);return b-a};b.prototype.generateElements=function(){this.target.append('<div class="pane"><div class="slider"></div></div>');this.content=c(this.target.children()[0]);this.slider=this.target.find(".slider");this.pane=this.target.find(".pane");this.scrollbarWidth=this.getScrollbarWidth();if(0===this.scrollbarWidth)this.scrollbarWidth=0;this.content.css({right:-this.scrollbarWidth+"px"});null!=c.browser.msie&&8>
parseInt(c.browser.version)&&this.pane.hide()};b.prototype.reset=function(){this.contentHeight=this.content[0].scrollHeight;this.paneHeight=this.pane.height();this.sliderHeight=this.paneHeight/this.contentHeight*this.paneHeight;this.scrollHeight=this.paneHeight-this.sliderHeight;this.slider.height(this.sliderHeight)};b.prototype.scroll=function(){var a;if(0>this.sliderY)this.sliderY=0;if(this.sliderY>this.scrollHeight)this.sliderY=this.scrollHeight;a=this.paneHeight-this.contentHeight+this.scrollbarWidth;
a=a*this.sliderY/this.scrollHeight;this.content.scrollTop(-a);return this.slider.css({top:this.sliderY})};b.prototype.scrollBottom=function(){this.reset();this.sliderY=this.scrollHeight;this.scroll()};b.prototype.scrollTop=function(){this.reset();this.sliderY=0;this.scroll()};b.prototype.stop=function(){this.removeEventListeners();return this.pane.hide()};return b}();c.fn.nanoScroller=function(b){var a;b||(b={});a=this.data("scrollbar");if(void 0===a)a=new d(this,b),this.data({scrollbar:a});else return a.reset(),
"bottom"===b.scroll&&a.scrollBottom(),"top"===b.scroll&&a.scrollTop(),!0===b.stop&&a.stop(),!1}}).call(this);