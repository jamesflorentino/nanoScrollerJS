...
a)};c.prototype.scrollTop=function(a){this.reset();this.content.scrollTop(a+0)};c.prototype.stop=function(){this.isDead=!0;this.removeEvents();this.pane.hide()};return c}();d.fn.nanoScroller=function(c){c||(c={});d.browser.msie&&8>parseInt(d.browser.version,10)||this.each(function(){var a,b;a=d(this);b=a.data("scrollbar");void 0===b&&(b=new g(a),a.data("scrollbar",b));return c.scrollBottom?b.scrollBottom(c.scrollBottom):c.scrollTop?b.scrollTop(c.scrollTop):"bottom"===c.scroll?b.scrollBottom(0):"top"===
c.scroll?b.scrollTop(0):c.stop?b.stop():b.reset()})}})(jQuery,window,document);