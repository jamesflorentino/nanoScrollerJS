...
b&&(a.contentScrollTop>=a.maxScrollTop?(a.options.preventPageScrolling&&a.preventScrolling(b,"down"),a.el.trigger("scrollend")):0===a.contentScrollTop&&(a.options.preventPageScrolling&&a.preventScrolling(b,"up"),a.el.trigger("scrolltop"))))},wheel:function(b){if(null!=b)return a.sliderY+=-b.wheelDeltaY||-b.delta,a.scroll(),!1},keydown:function(b){var c;if(null!=b&&(c=b.which,38===c||33===c||40===c||34===c||36===c||35===c))a.sliderY=isNaN(a.sliderY)?0:a.sliderY,k[c]=setTimeout(function(){a.handleKeyPress(c)},
100),b.preventDefault()},keyup:function(b){null!=b&&(b=b.which,a.handleKeyPress(b),null!=k[b]&&clearTimeout(k[b]))}}};c.prototype.addEvents=function(){var a;a=this.events;this.options.disableResize||this.win.bind("resize",a.resize);this.slider.bind("mousedown",a.down);this.pane.bind("mousedown",a.panedown).bind("mousewheel",a.wheel).bind("DOMMouseScroll",a.wheel);this.content.bind("mousewheel",a.scroll).bind("DOMMouseScroll",a.scroll).bind("touchmove",a.scroll).bind("keydown",a.keydown).bind("keyup",
a.keyup)};c.prototype.removeEvents=function(){var a;a=this.events;this.options.disableResize||this.win.unbind("resize",a.resize);this.slider.unbind("mousedown",a.down);this.pane.unbind("mousedown",a.panedown).unbind("mousewheel",a.wheel).unbind("DOMMouseScroll",a.wheel);this.content.unbind("mousewheel",a.scroll).unbind("DOMMouseScroll",a.scroll).unbind("touchmove",a.scroll).unbind("keydown",a.keydown).unbind("keyup",a.keyup)};c.prototype.generate=function(){var a,b,c,h,e;c=this.options;h=c.paneClass;
e=c.sliderClass;a=c.contentClass;this.el.append('<div class="'+h+'"><div class="'+e+'" /></div>');this.content=this.el.children("."+a);this.content.attr("tabindex",0);this.slider=this.el.find("."+e);this.pane=this.el.find("."+h);g&&(b={right:-g},this.el.addClass("has-scrollbar"));c.iOSNativeScrolling&&(null==b&&(b={}),b.WebkitOverflowScrolling="touch");null!=b&&this.content.css(b);c.alwaysVisible&&this.pane.css({opacity:1,visibility:"visible"});return this};c.prototype.restore=function(){this.stopped=
!1;this.pane.show();return this.addEvents()};c.prototype.reset=function(){var a,b,c,h,e,f,d;this.el.find("."+this.options.paneClass).length||this.generate().stop();this.stopped&&this.restore();a=this.content[0];c=a.style;h=c.overflowY;l&&this.content.css({height:this.content.height()});b=a.scrollHeight+g;f=this.pane.outerHeight();d=parseInt(this.pane.css("top"),10);e=parseInt(this.pane.css("bottom"),10);e=f+d+e;d=Math.round(e/b*e);d=d>this.options.sliderMinHeight?d:this.options.sliderMinHeight;"scroll"===
h&&"scroll"!==c.overflowX&&(d+=g);this.maxSliderTop=e-d;this.contentHeight=b;this.paneHeight=f;this.paneOuterHeight=e;this.sliderHeight=d;this.slider.height(d);this.events.scroll();this.pane.show();this.paneOuterHeight>=a.scrollHeight&&"scroll"!==h?this.pane.hide():this.el.height()===a.scrollHeight&&"scroll"===h?this.slider.hide():this.slider.show();return this};c.prototype.scroll=function(){this.sliderY=Math.max(0,this.sliderY);this.sliderY=Math.min(this.maxSliderTop,this.sliderY);this.content.scrollTop(-1*
((this.paneHeight-this.contentHeight+g)*this.sliderY/this.maxSliderTop));this.slider.css({top:this.sliderY});return this};c.prototype.scrollBottom=function(a){this.reset();this.content.scrollTop(this.contentHeight-this.content.height()-a).trigger("mousewheel");return this};c.prototype.scrollTop=function(a){this.reset();this.content.scrollTop(+a).trigger("mousewheel");return this};c.prototype.scrollTo=function(a){this.reset();a=f(a).offset().top;a>this.maxSliderTop&&(a/=this.contentHeight,this.sliderY=
a*=this.maxSliderTop,this.scroll());return this};c.prototype.stop=function(){this.stopped=!0;this.removeEvents();this.pane.hide();return this};return c}();f.fn.nanoScroller=function(c){var a,b,g,h,e,i;null!=c&&(g=c.scrollBottom,e=c.scrollTop,h=c.scrollTo,b=c.scroll,i=c.stop);a=f.extend({},n,c);this.each(function(){var d;if(d=f.data(this,"scrollbar"))f.extend(d.options,c);else{d=new m(this,a);f.data(this,"scrollbar",d)}return g?d.scrollBottom(g):e?d.scrollTop(e):h?d.scrollTo(h):b==="bottom"?d.scrollBottom(0):
b==="top"?d.scrollTop(0):b instanceof f?d.scrollTo(b):i?d.stop():d.reset()})}})(jQuery,window,document);